...
<div class="nav">
    <ul>
        ...
        <li <?php if($_SERVER["SCRIPT_NAME"]=="/admin/abrechnung.php"){?>class="active"<?php }?>><a href="abrechnung.php?year=<?php echo getdate()['year'];?>&month=<?php echo getdate()['mon'];?>"><svg><use xlink:href="#admin_abrechnung" /></svg></a></li>
